...
sound = Sound()
my_string = 'MILE'.upper() #upper() converts lowercase to upper
...
degs_per_robot_deg = 3.15 * wf # angle wheels turn when robot turns one degree on the spot
...
sequence={'M': 'ahco', 'I':'CaBnMo', 'L': 'Amo', 'E': 'acIgIOm'}
#'E': 'acIgIOm'
#'A': 'GiMbo',
#'I':'CaBnMo'
#'L': 'Amo'
